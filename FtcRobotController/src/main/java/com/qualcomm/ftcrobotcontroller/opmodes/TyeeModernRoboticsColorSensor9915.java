 ...
 */
/*
public class TyeeModernRoboticsColorSensor9915 extends ColorSensor implements I2cController.I2cPortReadyCallback {
    public static volatile int ADDRESS_I2C = 0x42;
    ...
    public TyeeModernRoboticsColorSensor9915(DeviceInterfaceModule deviceInterfaceModule, int physicalPort) {
